...
try:
    ...
    ## import yaml package of my propre envrionment.
    ## If you do not have the yaml package please run the following command
    # sudo python -m pip install pyyaml
    import sys
    sys.path.append('/home/khoanguyen/.local/lib/python3.6/site-packages')
    import yaml
