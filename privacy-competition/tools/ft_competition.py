...
run:
    python ft_competition.py --config_file ../configs/rcnn_rf_kmeans.yaml --model_name best_bank_competition.pkl --situation BANK
    python ft_competition.py --config_file ../configs/rcnn_rf_kmeans.yaml --model_name best_it_competition.pkl --situation IT
    python ft_competition.py --config_file ../configs/rcnn_rf_kmeans.yaml --model_name best_wait_competition.pkl --situation WAIT
    python ft_competition.py --config_file ../configs/rcnn_rf_kmeans.yaml --model_name best_accom_competition.pkl --situation ACCOM
...
def argument_parser():
    ...
    parser.add_argument("--fe", default=1, help="1 to turn on the focal exposure")
    parser.add_argument("--situation", required=True, help="IT, ACCOM, BANK, WAIT")
    parser.add_argument("--N", default=-1, help="Number of training profiles: "
                                                   "-1: ALL user profiles"
                                                   "N: N profiles (N < 400)")
    parser.add_argument(
        "--opts",
